...
lemma probEvent_bind_le_add_of_disagree {α β : Type} {mx : ProbComp α}
...
lemma probEvent_bind_le_add_bad_of_disagree {α β γ : Type} {mx : ProbComp α}
...
lemma probEvent_bind_le_add_bad_disagree {α β γ : Type} {mx : ProbComp α}
    {my : α → ProbComp β} {oc : α → ProbComp β} {ob : α → ProbComp γ}
